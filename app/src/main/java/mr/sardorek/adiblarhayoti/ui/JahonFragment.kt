...
import mr.sardorek.adiblarhayoti.databinding.FragmentJahonBinding
import mr.sardorek.adiblarhayoti.databinding.FragmentUzbBinding
import mr.sardorek.adiblarhayoti.model.AdibTogo
import mr.sardorek.adiblarhayoti.util.toast

class JahonFragment : Fragment() {
    private var _binding: FragmentJahonBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJahonBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun uploadAllData() {
        firebaseFirestore.collection("Jahon")
            .addSnapshotListener { success, error ->
                if (success != null) {
                    binding.progressBarJahon.isVisible = false
