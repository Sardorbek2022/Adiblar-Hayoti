...
class UzbFragment : Fragment() {
    private var _binding: FragmentUzbBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUzbBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun uploadAllData() {
        firebaseFirestore.collection("O'zbek")
            .addSnapshotListener { success, error ->
                if (success != null) {
                    binding.progressBarUzb.isVisible = false
